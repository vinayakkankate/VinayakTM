...
//const URL = 'http://192.168.9.15:4300/api/';
const profilePicApi='uploadCompanyLogo';
// const passportPicApi='companyUserUploadPassportPhoto';
// const nationalIdPicApi='companyUserUploadNationalIdPhoto';

@Component({
  selector: 'app-corporate-company-profile',
  templateUrl: './corporate-company-profile.component.html',
  styleUrls: ['./corporate-company-profile.component.css']
...
subTab:any;
    ...
    constructor(private spinnerService : SpinnerService,
        ...
        this.updatedData = this.authService.getUserData();
        this.userData=this.updatedData;
        this.subTab="corporateProfile";
    ...
    updateCompanyProfile(value:any){
      console.log(value);
        ...
        this.apisService.editCompanyByTM(form)
          .subscribe(data => {
            if(data.success){
              let templocalObj=this.authService.getUserData();
              templocalObj.CompanyId.profileSaveFlag =true;
              this.authService.setUserData(templocalObj);
